...
describe('When searching website search contents', function() {
  test('Searching for \'lorem ipsum dolor sit amet\' should populate search-results', function(done) {
    ...
    expect(document.getElementById('search-result-2')).toBeDefined()
    expect(document.getElementById('search-result-2').innerHTML.toLowerCase()).toMatch(/lorem ipsum dolor sit amet/m)
